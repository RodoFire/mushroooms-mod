...
public class TinyGreenMushroom extends BigMushroom implements BonemealableBlock {
    public TinyGreenMushroom(Properties settings, ResourceKey<ConfiguredFeature<?, ?>> featureKey) {
        super(settings);
        this.featureKey = featureKey;
    }

    private final ResourceKey<ConfiguredFeature<?, ?>> featureKey;
    public static final VoxelShape SHAPE = Block.box(1f, 0f, 1f, 15f, 7f, 15f);
