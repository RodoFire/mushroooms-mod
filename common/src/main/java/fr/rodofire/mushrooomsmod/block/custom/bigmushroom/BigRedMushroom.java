...
public class BigRedMushroom extends BigMushroom implements BonemealableBlock {
    private final ResourceKey<ConfiguredFeature<?, ?>> featureKey;

    public BigRedMushroom(Properties settings, ResourceKey<ConfiguredFeature<?, ?>> featureKey) {
        super(settings);
