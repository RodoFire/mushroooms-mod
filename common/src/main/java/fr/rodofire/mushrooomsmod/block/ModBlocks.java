...
public class ModBlocks {
    ...
    private static Supplier<Block> registerBlock(String name, Supplier<? extends Block> factory) {
        // NE PAS instancier le block ici. Laissez le DeferredRegister le créer au bon moment.
        Supplier<Block> supplier = BLOCK_HANDLER.register(name, factory::get);
    ...
    private static Supplier<Block> registerHiddenBlock(String id, Supplier<? extends Block> factory) {
        return BLOCK_HANDLER.register(id, factory::get);
    }
