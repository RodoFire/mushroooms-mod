...
public class ModItems {
    ...
    //Egg
    public static final Supplier<Item> GROKI_SPAWN_EGG = registerItem("groki_spawn_egg",() -> new SpawnEggItem(ModEntities.GROKI.get(), 0x765A34, 0x1BC2CF, new Item.Properties()));
    public static final Supplier<Item> BOLETE_COW_SPAWN_EGG = registerItem("bolete_cow_spawn_egg",() -> new SpawnEggItem(ModEntities.BOLETE_COW.get(), 0xBF28DD, 0xF4DBF9, new Item.Properties()));
    public static final Supplier<Item> PLOTI_SPAWN_EGG = registerItem("ploti_spawn_egg",() -> new SpawnEggItem(ModEntities.PLOTI.get(), 0x674f35, 0x4e361c, new Item.Properties()));
    public static final Supplier<Item> CRYSTAL_CREEPER_SPAWN_EGG = registerItem("crystal_creeper_spawn_egg",() -> new SpawnEggItem(ModEntities.CRYSTAL_CREEPER.get(), 0x50D122, 0xDE310F, new Item.Properties()));
    public static final Supplier<Item> CRYSTAL_GOLEM_SPAWN_EGG = registerItem("crystal_golem_spawn_egg",() -> new SpawnEggItem(ModEntities.CRYSTAL_GOLEM.get(), 0x9A9A9A, 0xE57FF3, new Item.Properties()));
    public static final Supplier<Item> SCHROOM_STICK_SPAWN_EGG = registerItem("schroom_stick_spawn_egg",() -> new SpawnEggItem(ModEntities.SCHROOM_STICK.get(), 0xd3ccc4, 0xd81a1a, new Item.Properties()));
    public static final Supplier<Item> SQUIRREL_STICK_SPAWN_EGG = registerItem("squirrel_spawn_egg",() -> new SpawnEggItem(ModEntities.SQUIRREL.get(), 0xedad34, 0xffeecd, new Item.Properties()));
    ...
    private static Supplier<Item> registerItem(String name, Supplier<? extends Item> factory) {
        return ITEM_HANDLER.register(name, factory::get);
    }
