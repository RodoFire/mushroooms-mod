...
public class ModItems {
    ...
    public static final Item SQUIRREL_STICK_SPAWN_EGG = registerItem("squirrel_stick_spawn_egg", new SpawnEggItem(ModEntities.SQUIRREL, 0xedad34, 0xffeecd, new FabricItemSettings()));
